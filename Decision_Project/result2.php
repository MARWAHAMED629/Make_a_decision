...
if (isset($_POST['about'])) {
                ...
                $query = "SELECT * FROM draft WHERE about LIKE ? OR about LIKE ?";
                ...
                if ($stmt->rowCount()) {
                    foreach ($stmt->fetchall() as $v) {
                        ...
                        <td>
                            ...
                            <td>
                                <a class="show-btn" target="blank" href="draft_project/img/<?php echo $v['img_draft']; ?>">Show</a>
                            </td>
                            <td>
                    ...
                    header('Location: about_draft.php');
