...
?>
    ...
    <div class="view-search-parent">
        <div class="container">
            ...
            <a href="admin/login.php"><button type="button" class="btn btn-primary" style="margin-right: 15px; padding: 10px 20px;">Cancel a decision</button></a>
            <a href="admin/login.php"><button type="button" class="btn btn-primary" style="margin-right: 15px; padding: 10px 20px;">Change Decision</button></a>
            <a href="admin/login.php"><button type="button" class="btn btn-primary" style="margin-right: 15px; padding: 10px 20px;">Enter a decision</button></a>
            <a href="view.php"><button type="button" class="btn btn-primary" style="margin-right: 15px; padding: 10px 20px;">Search for a decision</button></a>
