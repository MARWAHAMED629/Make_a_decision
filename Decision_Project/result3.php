...
if (isset($_POST['signature'])) {
                ...
                // $stmt = $pdo->prepare("SELECT * FROM draft where n_draft LIKE  '?' " );
                // $a = array('%' . $_POST['about'] . '%' );
                // $stmt->execute([
                //     $a
                // ]);
                $var1 = $_POST['signature'];
                $var2 = $_POST['signature'];

                $query = "SELECT * FROM draft WHERE signature LIKE ? OR signature LIKE ?";
        ...
        <table class="table">
            <thead>
                ...
                <th scope="col">Print Decisions </th>
                    <th scope="col"> Copy of decision</th>
            ...
            <tbody>
                ...
                if ($stmt->rowCount()) {
                    ...
                    header('Location: location_draft.php');
